...
@XmlRootElement(name = "signCustomerResponse", namespace = "http://amazon_management.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "signCustomerResponse", namespace = "http://amazon_management.com/")

public class SignCustomerResponse {
